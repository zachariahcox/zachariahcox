...
The goals of onboaring are to teach the new team member both the mechanical requirements of developing the feature (working with our tooling, finding code, etc) and how we develop features (how to find people who know things, cultural expectations around paired programming, documentation and communication expectations, etc.).
